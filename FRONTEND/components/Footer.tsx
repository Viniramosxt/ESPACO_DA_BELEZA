export default function Footer() {
  return (
    <footer id="contato" className="bg-dark-950 border-t border-gold-400/10">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              ...
              Seu espaço de beleza na Zona Norte de Manaus.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-gold-400 font-serif text-lg mb-4">Links Rápidos</h4>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border border-gold-400/30 flex items-center justify-center text-gold-400 hover:bg-gold-400/10 transition-all"
        ...
        {/* Bottom */}
        <div className="border-t border-gold-400/10 mt-12 pt-8 text-center">
          <p className="text-gray-600 text-sm">
            © 2026 Espaço da Beleza. Todos os direitos reservados.
          </p>
        </div>
      </div>
